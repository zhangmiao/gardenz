...
public final class OSUtils {
    ...
    /**
     * Determines if the OSUtils on which Ant is executing matches the given OSUtils
     ...
     * @return true if the OSUtils matches
     */
    ...
    /**
     * Determines if the OSUtils on which Ant is executing matches the given OSUtils name.
     * 
     * @param name
     *            the OSUtils name to check for
     * @return true if the OSUtils matches
     */
     ...
     * 
     * @param arch
     *            the OSUtils architecture to check for
     * @return true if the OSUtils matches
     */
     ...
     * 
     * @param version
     *            the OSUtils version to check for
     * @return true if the OSUtils matches
     */
